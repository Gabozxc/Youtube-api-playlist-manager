...
const PrivacyPolicy = () => {
  return (
    <Layout>
      <h1 className="text-2xl text-center font-bold mt-2">Privacy Policy</h1>
      <div className="policy max-w-[90%] mx-auto mb-5">
        <h2 className="text-xl mb-3 font-bold">Who we are</h2>
        <p>Our website address is: https://vixfid.com.</p>
        <h2 className="text-xl font-bold mb-2 mt-3">Comments</h2>
        <p>
          When visitors leave comments on the site we collect the data shown in
          the comments form, and also the visitor&rsquo;s IP address and browser
        ...
        <h2 className="text-xl font-bold mb-2 mt-3">Media</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mb-2 mt-3">Cookies</h2>
        <p>
        ...
        <p>
          ...
          select &ldquo;Remember Me&rdquo;, your login will persist for two
        ...
        <h2 className="text-xl font-bold mb-2 mt-3">Embedded content from other websites</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mb-2 mt-3">Who we share your data with</h2>
        <p>
          If you request a password reset, your IP address will be included in
          the reset email.
        </p>
        <h2 className="text-xl font-bold mb-2 mt-3">How long we retain your data</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mb-2 mt-3">What rights you have over your data</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mb-2 mt-3">Where we send your data</h2>
        <p>
